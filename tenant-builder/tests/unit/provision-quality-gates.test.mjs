 ...
 *
 * These test the logic extracted from provision.mjs by simulating
 * the same gate logic inline (since provision.mjs doesn't export functions).
 */

import { describe, it, expect } from 'vitest';

// ─── Replicated gate logic (mirrors provision.mjs exactly) ───
...
function isStrongHero(headline, businessName = '') {
...
function filterTestimonials(raw) {
