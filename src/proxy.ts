...
const DOMAIN_TO_SITE_FALLBACK: Record<string, string> = {
  ...
  'mj-contracting.norbotsystems.com': 'about-m-j-contracting-family-owned-excellence-m-j-contractin',
  'samandrez.norbotsystems.com': 'samandrez-premium-kitchen-bathroom-flooring-renovations',
