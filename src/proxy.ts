...
const DOMAIN_TO_SITE_FALLBACK: Record<string, string> = {
  ...
  'mj-contracting.norbotsystems.com': 'mj-contracting',
  'samandrez.norbotsystems.com': 'samandrez',
};
...
export async function proxy(request: NextRequest) {
  ...
  if (!siteId) {
    ...
    if (proxySecret && proxySecret === (process.env['INTERNAL_PROXY_SECRET'] || process.env['NEXT_PUBLIC_INTERNAL_PROXY_SECRET'])) {
