...
export type VisualizationRoomType = 'kitchen' | 'bathroom' | 'living_room' | 'bedroom' | 'basement' | 'dining_room' | 'exterior' | 'other';
export type VisualizationStyle = 'modern' | 'traditional' | 'farmhouse' | 'industrial' | 'minimalist' | 'contemporary' | 'transitional' | 'scandinavian' | 'coastal' | 'mid_century_modern';
